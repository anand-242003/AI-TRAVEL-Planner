...
export default function CreateTrip() {
  const { user, login } = useAuth(); // This will now work with AuthProvider
          ...
          try {
            if (response.access_token) {
              ...
              try {
                ...
                const tripData = JSON.parse(cleanResponse);
                console.log('Parsed Trip Data:', tripData);
                navigate('/trip-details', { state: { tripData: cleanResponse } });
              } catch (error) {
                console.error('Error generating trip:', error);
                toast('Error generating trip: Invalid response format. Please try again.');
              } finally {
